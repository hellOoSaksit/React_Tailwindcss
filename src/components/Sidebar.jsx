...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      w-full bg-white fixed top-0 max-h-screen shadow-2xl 
      sm:w-[90vw] md:w-[70vw] lg:w-[50vw] xl:w-[35vw] 
      transition-transform duration-300 z-20 px-4 lg:px-[35px] overflow-y-auto`}
    >
      ...
      <div className="flex flex-col gap-y-2 h-[500px] lg:h-[640px] overflow-y-auto border-b">
        {cart.map((item) => {
          return <CartItem item={item} key={item.id} />;
        })}
      </div>
      <div className="flex flex-col gap-y-3 py-4 mt-4 mb-8">
